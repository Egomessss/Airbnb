...
function Footer() {
  return (
    <footer className="text-sm mx-auto mb-4 px-3 md:px-16 py-1 border-t-[1px] border-gray-400 bg-white md:flex md:items-center md:justify-between md:fixed inset-x-0 bottom-0 z-10">
      <div>
