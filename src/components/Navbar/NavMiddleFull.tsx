...
function NavMiddleFull() {
  ...
  const [searchAnywhere, setSearchAnywhere] = React.useState(false)

  const OpenSearchPopOver = () => setSearchAnywhere(true)
  ...
  return (
    ...
    >
      <ul className="flex flex-row items-center text-xs gap-7 ">
        <li onClick={OpenSearchPopOver} className="border-r-2 pr-2 font-semibold">Anywhere</li>
