...
function ListingInfo() {
  return (
    <div className="py-6">
        ...
        <div>
          <div className="flex justify-between">
            <div className="flex flex-col">
              <p className="text-lg font-semibold">Entire rental unit</p>
              <p className="text-lg font-semibold">hosted by Pedro</p>
            </div>
            <div className="relative px-2">
              ...
              />
              <FaMedal className="text-2xl absolute text-yellow-500  z-20 bottom-0 right-0" />
            </div>
          </div>
        </div>
      ...
      <div>
        <div>
          <LanguageIcon className="block h-[24px] w-[24px]" />
          <p>Some info has been automatically translated</p>
          <a href="">Show original language</a>
        </div>
        ...
        <a href="">
          Show more <ChevronRightIcon className="block h-[24px] w-[24px]" />
        </a>
      </div>
      <div>
      ...
      <div>
        ...
        <p>Luz, Lagos, Faro, Portugal</p>
        <div className="w-[342px] h-[218px] border-black border-2"></div>
      </div>
      <div>
        <h2>7 nihts in Luz, Lagos</h2>
        <p>30 may 2023-5 Jun 2023</p>
        <Calendar />
      </div>
      <div>
        <StarIcon className="h-4" />
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            <p>Pedro is a Superhost</p>
            <p>
              Superhosts are experienced, highly rated hosts who are commited to
              proving great stays for their guests
            </p>
          </li>
          <li>
            <svg
